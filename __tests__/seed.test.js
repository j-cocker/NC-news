...
describe("seed", () => {
    ...
    describe("user_follows table", () => {
        test("user_follows table exists", () => {
            return db
                .query(
                    `SELECT EXISTS (
            SELECT FROM 
    ...
    test("user_follows data has been inserted correctly", () => {
        return db
            ...
            .then(({ rows: user_follows }) => {
                expect(user_follows).toHaveLength(3);
                user_follows.forEach((user_follow) => {
                    expect(user_follow).toHaveProperty("user_follow_id");
                    expect(user_follow).toHaveProperty("username");
                    expect(user_follow).toHaveProperty("follow");
                });
            });
    });
    ...
    test("emoji_article_user data has been inserted correctly", () => {
        return db
            ...
            .then(({ rows: emoji_article_user }) => {
                expect(emoji_article_user).toHaveLength(8);
                emoji_article_user.forEach((react) => {
                    expect(react).toHaveProperty("emoji_article_user_id");
                    expect(react).toHaveProperty("emoji_id");
                    expect(react).toHaveProperty("username");
                    expect(react).toHaveProperty("article_id");
                });
            });
    });
    test("user_topics data has been inserted correctly", () => {
        return db
            ...
            .then(({ rows: user_topics }) => {
                expect(user_topics).toHaveLength(4);
    ...
    test("user_article_votes data has been inserted correctly", () => {
        return db
            ...
            .then(({ rows: user_article_votes }) => {
                expect(user_article_votes).toHaveLength(4);
                user_article_votes.forEach((vote) => {
                    expect(vote).toHaveProperty("user_articles_vote_id");
                    expect(vote).toHaveProperty("username");
                    expect(vote).toHaveProperty("article_id");
                    expect(vote).toHaveProperty("vote_count");
                });
            });
    });
});
